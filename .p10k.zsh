# Generated by Powerlevel10k configuration wizard on 2021-02-06 at 10:48 JST.
...
# flat heads, flat tails, 2 lines, solid, left frame, light-ornaments, sparse,
...
() {
  ...
  typeset -g POWERLEVEL9K_TIME_FORMAT='%D{%F(%a) %H:%M:%S}'
